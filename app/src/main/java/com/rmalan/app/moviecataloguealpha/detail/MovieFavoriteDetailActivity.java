...
public class MovieFavoriteDetailActivity extends AppCompatActivity {
        ...
        alertDialogBuilder.setMessage(dialogMessage)
                ...
                .setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        long result = favoritesHelper.deleteMovie(favoriteItems.getId());
                        if (result > 0) {
                            Intent intent = new Intent();
                            intent.putExtra(EXTRA_POSITION, position);
                            setResult(RESULT_DELETE, intent);
                            Toast.makeText(MovieFavoriteDetailActivity.this, R.string.delete_item, Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(MovieFavoriteDetailActivity.this, R.string.delete_failed, Toast.LENGTH_SHORT).show();
                        }
                    }
                })
